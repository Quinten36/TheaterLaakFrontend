    ...
    return (
        <div>
            ...
            <div id="extraSettings">
                <img className="IconAP" src="./img/IntresseIcon.svg" alt="Knop voor mijn intresses aan te passen" />
                <img className="IconAP" src="./img/ticket 1.svg" alt="Knop voor tickets te bekijken of door te sturen of downloaden" />
                <img className="IconAP" src="./img/18 Settings Icon.svg" alt="Knop om de extra settings te bekijken" />
            </div>
